...
function WMESP_newSelectionAvailable()
{
    ...
    var selectedObject = W.selectionManager.getSelectedFeatures()[0].model;
    ...
    var landmarkPoi="(NATURAL_FEATURES|ISLAND|SEA_LAKE_POOL|RIVER_STREAM|FOREST_GROVE|FARM|CANAL|SWAMP_MARSH|DAM|PARK)"
    ...
    if (selectedObject.type=="venue")
    {
        var btnHandle = getElementsByClassName("geometry-type-control-buttons")[0];
...
function SplitPOI()
{
    ...
    var poi = W.selectionManager.getSelectedFeatures()[0].model;
    if (poi.type!="venue")
        return;
